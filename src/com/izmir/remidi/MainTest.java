...
public class MainTest {
    public static void main(String[] args) {
        ...
        Pesanan p = new Pesanan("Pizza Hot America Bread", 125000, 2);
        Transaksi transaksi = new Transaksi();
        transaksi.setDiskon(5000);
        ...
        System.out.println("Nama Pesana                 : "+ pelanggan.getPesanan().getNamaBrg());
        System.out.println("Jumlah Pesanan              : "+ pelanggan.getJmlBrg());
